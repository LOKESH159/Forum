...
public class RetriveQuestion {
	...
	@Autowired
	private RetrieveQUestionDao retrieveQUestionDao;
	public void setRetrieveQUestionDao(RetrieveQUestionDao retrieveQUestionDao) {
		this.retrieveQUestionDao = retrieveQUestionDao;
	}
