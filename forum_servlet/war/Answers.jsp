...
<div id="answers"></div>
 <div id="submitAnswer">
<textarea rows="4" cols="50" name="answer" onkeyup="return answerLength()" id="answer" placeholder="Write Your Answer"></textarea>
   <center><input type="submit" value="Post Your Answer" onclick="submitAnswer()"/></center>
</div>
<div id="loginModal" class="modal">
  <div class="modal-content" style="width:40%;height:30%">
    ...
    <table align="center">
    <tr> <td> Enter Your MailID:</td><td><input type="text" id="email"/></td></tr>
 <tr> <td>Enter Your Password:</td><td><input type="password" id="password"></td></tr>
 </table>
   <center><input type="submit" value="Log In" onclick="return logIn()"/></center>
    </div>
  </div>
</div>
<div id="myModal" class="modal">
 ...
 <tr id="questionBox"><td></td><td><textarea rows="4" cols="40" name="question" onkeyup="return questionLength()" id="question" placeholder="Write Your Question"></textarea></td></tr></table>
...
<div id="commentModal" class="modal">
 ...
 <tr> <td><textarea rows="4" cols="40" name="comment" onkeyup="return commentLength()" id="comment" placeholder="Write Your Comment"></textarea></td></tr>
 </table>
   <center><input type="submit" value="Submit Comment" onclick="return submitComment()"/></center>
    </div>
  </div>
</div>
</body>
